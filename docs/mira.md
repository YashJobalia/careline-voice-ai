...
New users may choose manual signup or guided registration collecting name, DOB, email and international phone one field at a time. Registration requires review and confirmation. AI-created passwords remain private. The existing registration deployment prerequisite described in `workspace-verification.md` remains pending.
