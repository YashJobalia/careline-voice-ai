...
navigate: {page: reception|appointments|specialists|account|doctor,mode?:list|calendar,month?:YYYY-MM,filter?:all|upcoming|past|cancelled|requests,accountSection?:profile|password|signin|signup|recovery,selectedDate?:YYYY-MM-DD,booking?:boolean,doctorId?:string,notesId?:UUID,behindScenes?:boolean}.
